...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_t_dim', type=int, default=32, help='hidden size of time embedding') # change from 128 to 32
    parser.add_argument('--hidden_dim', type=int, default=32, help='hidden size of word embedding') # change from 128 to 32
    ...
    parser.add_argument('--lr', type=float, default=1e-04, help='learning rate') # change from 1e-4 to 2e-4
